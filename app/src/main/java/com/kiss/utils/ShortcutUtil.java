...
import com.kiss.shortcut.SaveAllOreoShortcutsAsync;
import com.kiss.shortcut.SaveSingleOreoShortcutAsync;
...
public class ShortcutUtil {
    ...
    public static String getComponentName(Context context, ShortcutInfo shortcutInfo) {
        if (shortcutInfo != null && shortcutInfo.getActivity() != null) {
            UserManager manager = (UserManager) context.getSystemService(Context.USER_SERVICE);
            com.kiss.utils.UserHandle user = new com.kiss.utils.UserHandle(manager.getSerialNumberForUser(shortcutInfo.getUserHandle()), shortcutInfo.getUserHandle());
