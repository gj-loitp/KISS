...
import com.kiss.utils.SpaceTokenizer;
            ...
            if (appDrawable == null) {
                ...
                try {
                    ...
                    if (componentName != null) {
                        appDrawable = iconsHandler.getDrawableIconForPackage(PackageManagerUtils.getLaunchingComponent(context, componentName), new UserHandle());
                    }
